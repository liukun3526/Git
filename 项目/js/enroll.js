$(function(){
	...
	//验证码
	var $regAuth = $(".yours1").find('.yours_yanzheng')
	...
	//  密码验证过程
		var $regPwd = $(".yours2").find('.yours_password');
		var pwd;
		var pwd_b = false;
	...
	var pwdaff_b = false;
	var $regPwd1 = $(".yours3").find('.yours_password');
	...
	$(".enroll_btn").click(function(){
			...
			$.cookie("password", $(".yours2").find('.yours_password').val(),{expires: 7, path: '/' });
			alert("您已注册成功");
		}
	)
